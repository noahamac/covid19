- dashboard: county_cases__hospital_availability
  ...
  - title: Cases / ICU Beds
    ...
    width: 4
    height: 4
  - title: Confirmed Cases per ICU Bed (7 Day Extrapolation)
    name: Confirmed Cases per ICU Bed (7 Day Extrapolation)
    model: covid
    explore: covid_combined
    type: looker_column
  ...
  - title: State Mandate
    ...
    fields: [covid_combined.county, policies_by_state.non_essential_business_closures,
